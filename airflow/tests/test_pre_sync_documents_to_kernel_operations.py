...
from operations.pre_packages_operations import get_sps_packages
...
class TestGetSPSPackages(TestCase):
    ...
    @patch("operations.pre_packages_operations.Path")
    @patch("operations.pre_packages_operations.open")
    ...
    @patch("operations.pre_packages_operations.shutil")
    @patch("operations.pre_packages_operations.os.path.exists")
    @patch("operations.pre_packages_operations.open")
